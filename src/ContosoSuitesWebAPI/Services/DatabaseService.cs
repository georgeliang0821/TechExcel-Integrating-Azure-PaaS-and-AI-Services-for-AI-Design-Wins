...
public class DatabaseService : IDatabaseService
{
 ...
 [KernelFunction]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("The minimum date for which bookings should be retrieved. Only bookings on or after this date will be included")] DateTime dt
        )
    {
 ...
 [KernelFunction]
    [Description("Retrieves a list of bookings that are missing associated hotel room information")]    /// 
 ...
 [KernelFunction]
    [Description("Retrieves a list of bookings that have multiple hotel rooms associated with them")]    /// 
